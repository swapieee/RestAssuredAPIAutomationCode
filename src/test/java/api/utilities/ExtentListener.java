...
public class ExtentListener implements ITestListener {
	...
	ExtentSparkReporter htmlReporter; // used for user Interface
	ExtentReports reports; // used for Common Information
	ExtentTest test; // used for entries for test
	...
	public void configureReport() {
		...
		reports.setSystemInfo("Machine:", "Yukti's Laptop");
		reports.setSystemInfo("OS", "Windows 11");
		reports.setSystemInfo("user name:", "Swapnil");
	...
	// ITestResult - This class describe the result of the test
